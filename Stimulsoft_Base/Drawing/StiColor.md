...
| --- | --- | --- |
| **get2** `static` | [Color](../../Stimulsoft_System/Drawing/Color.md)[] | Translates an array with HTML colors representation to a GDI+ Stimulsoft.System.Drawing.Color structure. |
...
**get2**(**colors**: string[]): [Color](../../Stimulsoft_System/Drawing/Color.md)[]
