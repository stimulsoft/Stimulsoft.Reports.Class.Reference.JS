...
**addFile**(**fileName**: string, **dataStream**: [MemoryStream](../../Stimulsoft_System/IO/MemoryStream.md), **closeDataStream**: any): void

**Parameters**

- **fileName** (string)  
- **dataStream** ([MemoryStream](../../Stimulsoft_System/IO/MemoryStream.md))  
- **closeDataStream** (any)  
...
**begin**(**stream**: [MemoryStream](../../Stimulsoft_System/IO/MemoryStream.md), **leaveOpen**: boolean): void
