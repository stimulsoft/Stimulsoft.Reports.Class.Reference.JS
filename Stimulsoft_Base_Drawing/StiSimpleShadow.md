...
| --- | --- |
| **constructor**([Color](../Stimulsoft_System_Drawing/Color.md) color, [Point](../Stimulsoft_System_Drawing/Point.md) location, number size, boolean visible) |  |

**constructor**(**color**: [Color](../Stimulsoft_System_Drawing/Color.md), **location**: [Point](../Stimulsoft_System_Drawing/Point.md), **size**: number, **visible**: boolean)

**Parameters**

- **color** ([Color](../Stimulsoft_System_Drawing/Color.md))  
- **location** ([Point](../Stimulsoft_System_Drawing/Point.md))  
- **size** (number)  
- **visible** (boolean)  
