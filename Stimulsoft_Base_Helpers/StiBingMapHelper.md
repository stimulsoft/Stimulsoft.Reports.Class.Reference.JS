...
| --- | --- | --- |
| **getBingKey** `static` | string |  |
| **getImage** `static` | Promise<string> |  |
...
**getImage**(**size**: [Size](../Stimulsoft_System_Drawing/Size.md), **map**: { mapImage: string }, **userBingKey**: string, **pushPins**: string[]): Promise<string>
