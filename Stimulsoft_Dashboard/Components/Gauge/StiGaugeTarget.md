...
| --- | --- |
| **constructor**(boolean showLabel, [StiPlacement](../../../Stimulsoft_Report/Gauge/StiPlacement.md) placement) |  |

**constructor**(**showLabel**: boolean, **placement**: [StiPlacement](../../../Stimulsoft_Report/Gauge/StiPlacement.md))
