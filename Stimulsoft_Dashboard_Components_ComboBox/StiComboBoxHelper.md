...
**fetchItems**(**comboBoxElement**: StiComboBoxElement, **dataTable**: [StiDataTable](../Stimulsoft_Data_Engine/StiDataTable.md), **showBlanks**: boolean): [StiComboBoxItem](StiComboBoxItem.md)[]
