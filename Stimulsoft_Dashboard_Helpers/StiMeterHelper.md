...
| --- | --- | --- |
| **toAlias** `static` | string |  |
| **toCountExpression** `static` | string |  |
| **toCountExpression2** `static` | string |  |
| **toDataType** `static` | [Type](../Stimulsoft_System/Type.md) |  |
| **toExpression** `static` | string |  |
| **toSumExpression** `static` | string |  |
| **toSumExpression2** `static` | string |  |
| **toTotalExpression** `static` | string |  |
| **toTotalExpression2** `static` | string |  |
| **toTotalExpression3** `static` | string |  |
...
**toDataType**(**cell**: IStiAppDataCell): [Type](../Stimulsoft_System/Type.md)
...
**toTotalExpression**(**meter**: [StiMeter](../Stimulsoft_Dashboard_Components/StiMeter.md)): string
...
**toTotalExpression3**(**meter**: [StiMeter](../Stimulsoft_Dashboard_Components/StiMeter.md), **dashboard**: IStiDashboard): string
