...
**becomeRoot2**(**newRoot**: [IToken](../IToken.md), **oldRoot**: any): any
...
**create**(**payload**: [IToken](../IToken.md)): any
...
**create2**(**tokenType**: number, **fromToken**: [IToken](../IToken.md), **text**: string): any
...
**create3**(**fromToken**: [IToken](../IToken.md), **text**: string): any
...
**create5**(**tokenType**: number, **fromToken**: [IToken](../IToken.md)): any
...
**createToken2**(**tokenType**: number, **text**: string): [IToken](../IToken.md)
...
**getToken**(**t**: any): [IToken](../IToken.md)
...
**setTokenBoundaries**(**t**: any, **startToken**: [IToken](../IToken.md), **stopToken**: [IToken](../IToken.md)): void
