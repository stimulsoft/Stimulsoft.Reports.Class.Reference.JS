...
**create2**(**tokenType**: number, **fromToken**: [IToken](../IToken.md), **text**: string): void
...
**errorNode**(**input**: ITokenStream, **start**: [IToken](../IToken.md), **stop**: [IToken](../IToken.md), **e**: RecognitionException): any
