...
| --- | --- | --- |
| **charPositionInLine** | any | The index of the character relative to the beginning of the this.line 0..n-1 |
| **data** | string[] | The data being scanned |
| **lastMarker** | number | Track the last mark() call result value for use in rewind(). |
| **line** | any | this.line number 1..n within the input |
...
| **name** | string | What is name or source of this char stream? |
