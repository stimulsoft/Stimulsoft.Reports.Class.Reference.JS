...
| **children** | [ITree](ITree.md)[] | Get the children internal List; note that if you directly mess with the list, do so at your own risk. |
| **line** | number |  |
| **newChildren** | any |  |
| **newChildren** | any |  |
| **newChildren** | any |  |
| **parent** | [ITree](ITree.md) | BaseTree doesn't track parent pointers. |
