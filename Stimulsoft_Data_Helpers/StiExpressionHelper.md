...
| **newExpression** `static` | [Stimulsoft.Data.Expressions.NCalc.Expression](../Stimulsoft_Data_Expressions_NCalc/Expression.md) |  |
...
**compile**(**expression**: string): [LogicalExpression](../Stimulsoft_Data_Expressions_NCalc_Domain/LogicalExpression.md)
...
**newExpression**(**expression**: string): [Stimulsoft.Data.Expressions.NCalc.Expression](../Stimulsoft_Data_Expressions_NCalc/Expression.md)

**Parameters**

- **expression** (string)  

**Returns** [Stimulsoft.Data.Expressions.NCalc.Expression](../Stimulsoft_Data_Expressions_NCalc/Expression.md)
