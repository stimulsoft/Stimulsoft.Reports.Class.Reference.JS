...
| --- | --- |
| **constructor**([IStiAppDictionary](../Stimulsoft_Base/IStiAppDictionary.md) dictionary, [DataTable](../Stimulsoft_System_Data/DataTable.md) table, IStiMeter[] meters) |  |

**constructor**(**dictionary**: [IStiAppDictionary](../Stimulsoft_Base/IStiAppDictionary.md), **table**: [DataTable](../Stimulsoft_System_Data/DataTable.md), **meters**: IStiMeter[])
