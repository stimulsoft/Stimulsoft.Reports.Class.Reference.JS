...
**parseCode**(**code**: string, **outputCode**: [StringBuilder](../../Stimulsoft_System/Text/StringBuilder.md), **outputText**: [StringBuilder](../../Stimulsoft_System/Text/StringBuilder.md), **fnc1**: string, **addLeadingFnc1**: boolean): string

**Parameters**

- **code** (string)  
- **outputCode** ([StringBuilder](../../Stimulsoft_System/Text/StringBuilder.md))  
- **outputText** ([StringBuilder](../../Stimulsoft_System/Text/StringBuilder.md))  
- **fnc1** (string)  
