...
| --- | --- |
| **constructor**(StiDataSource dataSource, [DataRow](../../Stimulsoft_System/Data/DataRow.md) dataRow) |  |

**constructor**(**dataSource**: StiDataSource, **dataRow**: [DataRow](../../Stimulsoft_System/Data/DataRow.md))

**Parameters**

- **dataSource** (StiDataSource)  
- **dataRow** ([DataRow](../../Stimulsoft_System/Data/DataRow.md))  
