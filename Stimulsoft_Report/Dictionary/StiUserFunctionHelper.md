...
**convertArgumentTypeToString**(**type**: [StiUserFunctionArgumentType](StiUserFunctionArgumentType.md), **language**: [StiReportLanguageType](../StiReportLanguageType.md)): string
...
**generateArguments**(**language**: [StiReportLanguageType](../StiReportLanguageType.md), **functionn**: [StiUserFunction](StiUserFunction.md)): string
...
**generateFirstLineScript**(**language**: [StiReportLanguageType](../StiReportLanguageType.md), **functionn**: [StiUserFunction](StiUserFunction.md)): string
...
**getReturnTypeScript**(**language**: [StiReportLanguageType](../StiReportLanguageType.md), **functionn**: [StiUserFunction](StiUserFunction.md)): string
...
**invokeFunction**(**func**: [StiUserFunction](StiUserFunction.md), **report**: [StiReport](../StiReport.md), **args**: any[]): any
