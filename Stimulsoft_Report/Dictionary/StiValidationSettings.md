...
**createFromXml**(**xmlNode**: [XmlNode](../../Stimulsoft_System/Xml/XmlNode.md)): [StiValidationSettings](StiValidationSettings.md)
...
**validate**(**value**: any, **type**: [Type](../../Stimulsoft_System/Type.md), **report**: [StiReport](../StiReport.md), **variable**: StiVariable): void
