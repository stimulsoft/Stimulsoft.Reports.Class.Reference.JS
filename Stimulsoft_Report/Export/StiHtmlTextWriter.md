...
| --- | --- |
| **constructor**([TextWriter](../../Stimulsoft_System/IO/TextWriter.md) baseStream) |  |

**constructor**(**baseStream**: [TextWriter](../../Stimulsoft_System/IO/TextWriter.md))

**Parameters**

- **baseStream** ([TextWriter](../../Stimulsoft_System/IO/TextWriter.md))  
...
| --- | --- | --- |
| **flush** | void |  |
| **getStream** | [TextWriter](../../Stimulsoft_System/IO/TextWriter.md) |  |
| **write** | void |  |
| **writeAttribute** | void |  |
| **writeBeginTag** | void |  |
| **writeEndTag** | void |  |
...
**Returns** [TextWriter](../../Stimulsoft_System/IO/TextWriter.md)
