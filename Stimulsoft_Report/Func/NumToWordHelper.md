...
| --- | --- | --- |
| **addWords** `static` | string |  |
| **determinateCurrencies** `static` | void |  |
...
**determinateCurrencies**(**culture**: [CultureInfo](../../Stimulsoft_System/Globalization/CultureInfo.md), **currencyISO**: string, **integerPart**: number, **decimalPart**: number, **REFmainCurrency**: any, **REFcentCurrency**: any): void
