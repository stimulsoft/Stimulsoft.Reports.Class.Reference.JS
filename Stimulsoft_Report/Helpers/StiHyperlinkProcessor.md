...
**getBytes**(**report**: [StiReport](../StiReport.md), **hyperlink**: string): number[]
...
**getImage**(**report**: [StiReport](../StiReport.md), **hyperlink**: string): [Image](../../Stimulsoft_System/Drawing/Image.md)
...
**getRealDataColumnFromHyperlink**(**report**: [StiReport](../StiReport.md), **hyperlink**: string): string
...
**getString**(**report**: [StiReport](../StiReport.md), **hyperlink**: string): string
