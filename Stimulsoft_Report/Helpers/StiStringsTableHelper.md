...
| **loadDataTableFromPackedString** `static` | [DataTable](../../Stimulsoft_System/Data/DataTable.md) |  |
| **loadDataTableFromString** `static` | [DataTable](../../Stimulsoft_System/Data/DataTable.md) |  |
| **loadDataTableFromStringRows** `static` | [DataTable](../../Stimulsoft_System/Data/DataTable.md) |  |
...
**loadDataTableFromPackedString**(**content**: string, **columns**: string[]): [DataTable](../../Stimulsoft_System/Data/DataTable.md)
...
**loadDataTableFromString**(**content**: string, **columns**: string[]): [DataTable](../../Stimulsoft_System/Data/DataTable.md)
...
**loadDataTableFromStringRows**(**rows**: string[][], **columns**: string[]): [DataTable](../../Stimulsoft_System/Data/DataTable.md)
...
**saveDataTableToCache**(**element**: IStiElement, **table**: [DataTable](../../Stimulsoft_System/Data/DataTable.md), **saveHeaders**: any): void
...
**saveDataTableToPackedString**(**table**: [DataTable](../../Stimulsoft_System/Data/DataTable.md)): string
...
**saveDataTableToString**(**table**: [DataTable](../../Stimulsoft_System/Data/DataTable.md)): string
...
**saveDataTableToStringRows**(**table**: [DataTable](../../Stimulsoft_System/Data/DataTable.md), **saveHeaders**: any): string[][]
