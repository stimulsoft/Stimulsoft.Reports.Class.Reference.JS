...
**getColorByIndex**(**index**: number, **count**: number, **seriesColor**: [Color](../Stimulsoft_System_Drawing/Color.md)[]): [Color](../Stimulsoft_System_Drawing/Color.md)

**Parameters**

- **index** (number)  
- **count** (number)  
- **seriesColor** ([Color](../Stimulsoft_System_Drawing/Color.md)[])  
...
**getColorBySeries**(**series**: IStiSeries, **seriesColor**: [Color](../Stimulsoft_System_Drawing/Color.md)[]): [Color](../Stimulsoft_System_Drawing/Color.md)
