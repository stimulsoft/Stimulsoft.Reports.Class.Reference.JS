...
| --- | --- |
| **constructor**(any auto, any minimum, any maximum) |  |

**constructor**(**auto**: any, **minimum**: any, **maximum**: any)
...
| --- | --- | --- |
| **clone** | [StiAxisRange](StiAxisRange.md) |  |
| **implements** | any[] |  |
...
**Returns** [StiAxisRange](StiAxisRange.md)
