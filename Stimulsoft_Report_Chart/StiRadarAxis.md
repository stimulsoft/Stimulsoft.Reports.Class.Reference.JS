...
| --- | --- |
| **constructor**(IStiAxisRange range) |  |

**constructor**(**range**: IStiAxisRange)
...
| --- | --- | --- |
| **clone** | [StiRadarAxis](StiRadarAxis.md) |  |
| **implements** | any[] |  |
...
**Returns** [StiRadarAxis](StiRadarAxis.md)
...
| **jsonLoadFromJsonObjectArea** | any |  |
| **range** | IStiAxisRange |  |
| **visible** | any |  |
