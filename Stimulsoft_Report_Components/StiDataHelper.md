...
**getFilterExpression**(**filter**: [StiFilter](StiFilter.md), **fullColumnName**: string, **report**: [StiReport](../Stimulsoft_Report/StiReport.md)): string
...
| **expr** | any |  |
| **expr** | any |  |
| **filterEventHandler** | any |  |
| **groupHeaderComponents** | any |  |
