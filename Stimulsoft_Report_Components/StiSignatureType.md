...
| --- | --- |
| **constructor**(string fullName, string initials, [StiSignatureStyle](../Stimulsoft_Base_SignatureFonts/StiSignatureStyle.md) style) |  |

**constructor**(**fullName**: string, **initials**: string, **style**: [StiSignatureStyle](../Stimulsoft_Base_SignatureFonts/StiSignatureStyle.md))
...
**createFromXml**(**xmlNode**: [XmlNode](../Stimulsoft_System_Xml/XmlNode.md)): [StiSignatureType](StiSignatureType.md)
