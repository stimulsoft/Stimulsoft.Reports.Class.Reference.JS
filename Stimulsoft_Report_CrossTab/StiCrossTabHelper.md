...
| **buildCrossForCrossTabDataSource** `static` | [DataTable](../Stimulsoft_System_Data/DataTable.md) |  |
| **createCrossForCrossTabDataSource** `static` | [DataTable](../Stimulsoft_System_Data/DataTable.md) |  |
...
**buildCrossForCrossTabDataSource**(**masterCrossTab**: StiCrossTab, **designTime**: boolean): [DataTable](../Stimulsoft_System_Data/DataTable.md)
...
**createCrossForCrossTabDataSource**(**masterCrossTab**: StiCrossTab): [DataTable](../Stimulsoft_System_Data/DataTable.md)
