...
**renderStyles**(**useBookmarks**: boolean, **exportBookmarksOnly**: boolean, **cssStyles**: [Hashtable](../Stimulsoft_System_Collections/Hashtable.md)): void

**Parameters**

- **useBookmarks** (boolean)  
- **exportBookmarksOnly** (boolean)  
- **cssStyles** ([Hashtable](../Stimulsoft_System_Collections/Hashtable.md))  
