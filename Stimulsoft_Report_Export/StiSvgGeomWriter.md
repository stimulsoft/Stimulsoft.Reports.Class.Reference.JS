...
| --- | --- |
| **constructor**([XmlTextWriter](../Stimulsoft_System_Xml/XmlTextWriter.md) writer) |  |

**constructor**(**writer**: [XmlTextWriter](../Stimulsoft_System_Xml/XmlTextWriter.md))
...
**drawFontIcon**(**color**: [Color](../Stimulsoft_System_Drawing/Color.md), **icon**: [StiFontIcons](../Stimulsoft_Report_Helpers/StiFontIcons.md), **rect**: RectangleD): void
...
**drawPolyline**(**points**: PointD[], **pen**: [Pen](../Stimulsoft_System_Drawing/Pen.md)): void
...
**drawString**(**st**: string, **font**: [Font](../Stimulsoft_Base_Dashboard/Font.md), **brush**: any, **rect**: RectangleD, **sf**: [StringFormat](../Stimulsoft_System_Drawing/StringFormat.md)): void
...
**fillRectangle2**(**rect**: RectangleD, **color**: [Color](../Stimulsoft_System_Drawing/Color.md)): void
