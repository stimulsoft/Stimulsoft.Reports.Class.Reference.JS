...
| **getColors** `static` | [Color](../Stimulsoft_System_Drawing/Color.md)[] |  |
...
**getStates**(**report**: [StiReport](../Stimulsoft_Report/StiReport.md), **id**: [StiMapID](StiMapID.md), **lang**: string): string[]
