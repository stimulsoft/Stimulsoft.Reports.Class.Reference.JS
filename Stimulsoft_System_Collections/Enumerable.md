...
| --- | --- | --- |
| **list** | [Stimulsoft.System.Collections.Generic.List](../Stimulsoft_System_Collections_Generic/List.md)<T> |  |
| **source** | Iterable<T> |  |
...
| **first** | T |  |
| **firstOrDefault** | T |  |
| **groupBy** | [Stimulsoft.System.Collections.Generic.List](../Stimulsoft_System_Collections_Generic/List.md)<Grouping<K, T>> |  |
| **lastOrDefault** | T |  |
| **max** | S |  |
| **min** | S |  |
...
**groupBy**(**keySelector**: (value: T)): [Stimulsoft.System.Collections.Generic.List](../Stimulsoft_System_Collections_Generic/List.md)<Grouping<K, T>>

**Parameters**

- **keySelector** ((value: T))  

**Returns** [Stimulsoft.System.Collections.Generic.List](../Stimulsoft_System_Collections_Generic/List.md)<Grouping<K, T>>
