...
| **first** | T |  |
| **firstOrDefault** | T |  |
| **firstOrDefaultAsDateTime** | [DateTime](../Stimulsoft_System/DateTime.md) |  |
...
| **toLookup** | [Hashtable](../Stimulsoft_System_Collections/Hashtable.md) | Creates a Lookup from an List according to a specified key selector function. |
| **toString2** `static` | string |  |
| **tryCastToBool** | [List](List.md)<boolean | null> |  |
| **tryCastToDateTime** | [List](List.md)<[DateTime](../Stimulsoft_System/DateTime.md)> |  |
...
| **tryCastToTimeSpan** | [List](List.md)<[TimeSpan](../Stimulsoft_System/TimeSpan.md)> |  |
...
**create**(**t**: [Stimulsoft.System.Type](../Stimulsoft_System/Type.md), **values**: any[]): [List](List.md)<T>

**Parameters**

- **t** ([Stimulsoft.System.Type](../Stimulsoft_System/Type.md))  
- **values** (any[])  
...
**toLookup**(**keySelector**: (value: T)): [Hashtable](../Stimulsoft_System_Collections/Hashtable.md)
...
**Returns** [Hashtable](../Stimulsoft_System_Collections/Hashtable.md) — A Lookup that contains keys and values.
...
**Returns** [List](List.md)<[DateTime](../Stimulsoft_System/DateTime.md)>
...
**Returns** [List](List.md)<[TimeSpan](../Stimulsoft_System/TimeSpan.md)>
