...
**drawString**(**text**: string, **font**: [Font](../Stimulsoft_Base_Dashboard/Font.md), **brush**: [Brush](Brush.md), **x**: number, **y**: number): void
...
**measureChars**(**chars**: number[], **count**: number, **font**: [Font](../Stimulsoft_Base_Dashboard/Font.md)): [Size](Size.md)
...
**measureString**(**text**: string, **font**: [Font](../Stimulsoft_Base_Dashboard/Font.md), **width**: number, **useCache**: any, **multiple**: any, **angle**: any, **replaceTags**: any): [Size](Size.md)
