...
| **getConstants** `static` | [Hashtable](../../../Stimulsoft_System/Collections/Hashtable.md) |  |
...
**getBorderJson**(**border**: [StiSimpleBorder](../../../Stimulsoft_Base/Drawing/StiSimpleBorder.md)): KeyObjectType
...
**getConstants**(**value**: string, **cells**: any): [Hashtable](../../../Stimulsoft_System/Collections/Hashtable.md)
...
**getFontJson**(**font**: [Font](../../../Stimulsoft_Base/Dashboard/Font.md)): KeyObjectType
